...
Set "magnetic_cellsize", "size_x" and "size_y" variables in the main function of the script (all in meters).
Set "file1" and "file2" variables as file paths for the two WFP databases in "mfp3" or "mfp4" format

Input parameters:
	1) settings_json
	2) mfp_1 - 1st MFP file to compare
	3) mfp_2 - 2nd MFP file to compare
	


Output is:
console output in csv format
