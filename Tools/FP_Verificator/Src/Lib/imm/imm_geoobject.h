...
bool_t vector2f_equal(const vector2f_t *point1, const vector2f_t *point2);

void vector2f_swap(vector2f_t *p1, vector2f_t *p2);

float vector2f_distance(const vector2f_t *p1, const vector2f_t *p2);

void correct_slope(float *slope);

bool_t edge_equal(const edge_t *edge1, const edge_t *edge2);
...
bool_t polygon_free(polygon_t *polygon);
