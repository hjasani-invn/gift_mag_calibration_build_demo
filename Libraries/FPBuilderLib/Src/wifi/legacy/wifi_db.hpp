...
class WiFi_DB
{
    public:
        ...
        typedef struct
        {
            ...
            WiFi_Location location;     /**< coordinates */
        ...
        * \return histogram
        */
        static WiFi_DB::APHist APData2Hist( const WiFi_DB::APData &Ap );
